...
public class AimPanel extends JPanel implements ActionListener,MouseListener  {
    ...
    public AimPanel(JFrame jFrame, int time, int delay, int maxCircles){
        this.jFrame = jFrame;
        this.time = time;
    ...
    public void paint(Graphics g) {
        ...
        if(this.drawed == 0 && (((this.maxCircles != 0) && this.drawedCount < this.maxCircles) || this.maxCircles == 0) && (((this.time != 0) && this.wholeTime > unixTime) || this.time == 0) ) {
